...
def introscreen():
    ...
    while not gameStart:
        ...
        clock.tick(FPS)
        if temp_mario.isJumping == False and temp_mario.isBlinking == False:
            gameStart = True
    ...
    while not gameQuit:
        ...
        while not gameOver:
                    ...
                    if event.type == pygame.KEYDOWN:
                        if event.key == pygame.K_SPACE:
                            if playerMario.rect.bottom == int(0.98 * height):
                                ...
                                if pygame.mixer.get_init() != None:
                                    jump_sound.play()
                                playerMario.movement[1] = -1 * playerMario.jumpSpeed
            ...
            for c in wall1:
                ...
                if pygame.sprite.collide_mask(playerMario, c):
            ...
            for p in mushrooms:
                ...
                if pygame.sprite.collide_mask(playerMario, p):
                    playerMario.isDead = True
                    if pygame.mixer.get_init() != None:
                        die_sound.play()
            ...
            if len(wall1) < 2:
                if len(wall1) == 0:
                    last_obstacle.empty()
                    last_obstacle.add(Wall(gamespeed, 40, 40))
                else:
